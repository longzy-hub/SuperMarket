...
<head>
    ...
    <jsp:include page="/template/order/toBeDeliveredListTemplate.jsp"/>
                ...
                <div class="col-xs-12 ">
                    <div class="col-xs-12 fa-border" >
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tbody id="toBeDeliveredList">

                            </tbody>
                        </table>
                        <div class="row " id="toBeDeliveredPage"></div>
                    </div>
                </div><!-- /.col-xs-12 -->
            </div><!-- /.row -->
        </div> <!--/.page-content-->
...
<script src="/js/order/toBeDelivered.js"></script>
