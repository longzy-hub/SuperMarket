...
<head>
    ...
    <jsp:include page="/template/order/handledOrderListTemplate.jsp"/>
                ...
                <div class="col-xs-12 ">
                    <div class="col-xs-12 fa-border" >
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tbody id="handledOrderList">

                            </tbody>
                        </table>
                        <div class="row " id="handledOrderPage"></div>
                    </div>
                </div><!-- /.col-xs-12 -->
            </div><!-- /.row -->
        </div> <!--/.page-content-->
...
<script src="/js/order/handledOrder.js"></script>
</body>
</html>
