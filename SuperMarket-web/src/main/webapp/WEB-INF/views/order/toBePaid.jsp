...
<head>
    ...
    <jsp:include page="/template/order/toBePaidListTemplate.jsp"/>
                ...
                <div class="col-xs-12 ">
                    <div class="col-xs-12 fa-border" >
                        <ul class="list-inline">
                            ...
                            <input type="hidden" id="search_status" value="1"/>
                        </ul><!--/.ul-->
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tbody id="toBePaidList">

                            </tbody>
                        </table>
                        <div class="row " id="toBePaidPage"></div>
                    </div>
                </div><!-- /.col-xs-12 -->
            </div><!-- /.row -->
        </div> <!--/.page-content-->
...
<script src="/js/order/toBePaid.js"></script>
