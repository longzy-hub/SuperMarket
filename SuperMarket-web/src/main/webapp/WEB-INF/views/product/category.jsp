...
<head>
    ...
    <jsp:include page="/template/product/categoryListTemplate.jsp"/>
    <jsp:include page="categoryForm/categoryForm.jsp"/>
</head>
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <ul class="list-inline fa-border">
                        <li><button type="button" class="btn btn-warning fa fa-plus category-add">添加分类</button></li>
                    ...
                    <div class="col-xs-12 fa-border" >
                        <ul class="list-inline">
                            ...
                            <li>分类名称&nbsp;&nbsp;<input type="search" id="category_name" name="category_name" placeholder="分类名称"/></li>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="row" id="categoryPage"></div>
                    </div>
                </div><!-- /.col-xs-12 -->
            </div><!-- /.row -->
        </div> <!--/.page-content-->
