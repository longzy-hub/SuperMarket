    	...
    	<form class="form-login" id="login" method="post">
    		<ul>
    			<li class="form-group has-success has-feedback">
					...
					<input type="text" class="form-control" placeholder="账号(手机号)" id="telephone" name="telephone" required />
    			</li>
    			<li class="form-group has-success has-feedback">
    			...
    			<li class="form-group has-success has-feedback">
    				...
    				<input type="text" class="form-control code" placeholder="验证码" name="vercode" required />
					<canvas id="canvas"></canvas>
					<span style="color: red" id="codeMessage"></span>
    			</li>
    			<li>
