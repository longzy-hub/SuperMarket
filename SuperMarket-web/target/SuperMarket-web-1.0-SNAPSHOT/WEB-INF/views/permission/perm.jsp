...
<head>
    ...
    <jsp:include page="/template/permission/permListTemplate.jsp"/>
    <jsp:include page="permForm/permForm.jsp"/>
</head>
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <ul class="list-inline fa-border">
                        <li><button type="button" class="btn btn-warning fa fa-plus perm-add">添加权限</button></li>
                    </ul>
...
<script src="/js/permission/perm.js"></script>
