            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <span class="user-info"><small>欢迎,</small>User</span>
...
<div class="main-container ace-save-state" id="main-container">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a class="popstyle" target="_blank" href="/sys/role/acl.page">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限管理
                        </a>
                        <b class="arrow"></b>
    ...
    <div class="main-content">
        <!-- 设置每个页面显示位置 -->
        <div class="main-content">
            <iframe id="innerFrame" src="/product/productShow.page" width="100%" style="min-height: 768px;"></iframe>
        </div>
    </div><!-- /.main-content -->
