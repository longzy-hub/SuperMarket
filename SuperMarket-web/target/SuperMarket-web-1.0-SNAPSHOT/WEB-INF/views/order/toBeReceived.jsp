...
<head>
    ...
    <jsp:include page="/template/order/toBeReceivedListTemplate.jsp"/>
                ...
                <div class="col-xs-12 ">
                    <div class="col-xs-12 fa-border" >
                        <ul class="list-inline">
                            ...
                            <input type="hidden" id="search_status" value="3"/>
                        </ul><!--/.ul-->
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tbody id="toBeReceivedList">

                            </tbody>
                        </table>
                        <div class="row " id="toBeReceivedPage"></div>
                    </div>
                </div><!-- /.col-xs-12 -->
            </div><!-- /.row -->
        </div> <!--/.page-content-->
...
<script src="/js/order/toBeReceived.js"></script>
</body>
</html>
